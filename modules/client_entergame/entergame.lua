...
function EnterGame.init()
  ...
  if clientVersion == 0 then clientVersion = 850 end
  ...
  EnterGame.setUniqueServer(serverIP, 7171, 850) -- 25.140.142.183
end
